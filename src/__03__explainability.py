...
def run_explainability(index: int = 24) -> None:
    # ===============================
    # Load Processed Data
    # ===============================
    ...
    for name, model in models.items():
        ...
        if name == 'SVM':
            ...
            if hasattr(explainer, 'model') and hasattr(explainer.model,
                                                       'output_type') and explainer.model.output_type == 'probability':
        ...
        features = X_test.iloc[:sv.shape[0]] if not isinstance(sv, shap._explanation.Explanation) else X_test.iloc[
                                                                                                       :len(sv)]
        ...
        # ===============================
        # Save SHAP Local Explanation Plot
        # ===============================
